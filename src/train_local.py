...
def main():
    ...
    if MLFLOW_AVAILABLE:
        try:
            ...
            mlflow.start_run(run_name=f"train-local-{int(time.time())}")
            mlflow_enabled = True
    ...
    try:
        for epoch in range(start_epoch, args.epochs):
            ...
            if val_acc > best_acc:
                ...
                best_checkpoint_path = os.path.join(args.save_dir, 'best_local.pth')
            ...
            latest_checkpoint_path = os.path.join(args.save_dir, 'latest_local.pth')
